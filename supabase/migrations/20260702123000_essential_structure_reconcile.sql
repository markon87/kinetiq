...
drop policy if exists "uploaded_analyses_select_own" on public.uploaded_analyses;
create policy "uploaded_analyses_select_own" on public.uploaded_analyses
for select
using (auth.uid() = user_id);

drop policy if exists "uploaded_analyses_insert_own" on public.uploaded_analyses;
create policy "uploaded_analyses_insert_own" on public.uploaded_analyses
for insert
with check (auth.uid() = user_id);

drop policy if exists "uploaded_analyses_delete_own" on public.uploaded_analyses;
